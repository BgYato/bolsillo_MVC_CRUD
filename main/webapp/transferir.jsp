    ...
    <div class="cuenta-section">  
        <div class="tarjeta" id="tarjeta" style="display: none;">
            <div class="alerta-ok">
                <div class="alerta-ok_p">	
                    <p>
                        Felicidades, has transferido satisfactoriamente la cantidad de 
        ...
        <div class="cuenta-iniciar">
            ...
            <form action="bolsillo" class="cuenta_form" method="post">
                ...
                <input type="submit" value="transferir" class="cuenta_form-input_submit" title="Enviar" name="datos">
            </form>
        </div>
    </div>
    <!-- Enlaces a JS -->
