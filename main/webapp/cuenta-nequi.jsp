...
<body>      
    ...
    <div class="burbujas-nequi">
        <div class="b1"></div>
        <div class="b2"></div>
        <div class="b3"></div>
    </div>
    <div class="cuenta_nequi-logo">
        <img src="public/img/logo_nequi.png" alt="Logo de Nequi">
    </div>
    ...
    <div class="cuenta-section">
        <div class="cuenta-crear">
            ...
            <form action="usuario" class="cuenta_form" method="post">
                ...
                <input type="submit"  id="form_cuenta-submit-re-nequi" value="Registrar" name="datos" class="cuenta_form-input_submit color-morado">
            </form>
        </div>
        <div class="cuenta-iniciar">
            ...
            <form action="usuario" class="cuenta_form" method="post">
                ...
                <div class="cuenta_form-group">
                    <label for="pwd" class="cuenta_form-label">Contraseña.</label>
                    <input type="password" name="pwd" id="pwd" class="cuenta_form-input" placeholder="Ingrese su contraseña">
                </div>
                <input type="submit"  id="form_cuenta-submit-in" name="datos" value="Ingresar" class="cuenta_form-input_submit color-morado">
            </form>
        </div>
    </div>
    <!-- Enlaces a JS -->
